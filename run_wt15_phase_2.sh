...
--dropatt 0.0 \
--emb_dropout 0.0 \
--work_dir wt15_final_corrected_fine \
--activation_fn relu \
--log_interval 1000 \
--eval_interval 4000
"
...
python3 -m torch.distributed.launch --nproc_per_node=$ngpus ../code_march_corrected/main.py $args \
   --mode train  --train_mode  finetune \
   --skip_retain  \
   --cross_head_attn --ch_prob 0.1   --dropout 0.15
...
#
#
#echo "Pruning experiments"
#python3 -m torch.distributed.launch --nproc_per_node=$ngpus ../code_march_corrected/main.py $args \
#  --mode prune --eval_batch_size 10 --batch_size 10 --eval_tgt_len 128 --tgt_len 128  --mem_len 640 --clamp_len 800  --same_length
